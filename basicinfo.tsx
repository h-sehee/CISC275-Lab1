...
const yourName : String = "Sehee Hwang";
let yourPronouns : String = "She/Her";
const yourMajor : String = "Computer Science";
let classification : String = "Sophomore";
let oneExcite : String = "Learning about Github";
let anyConcerns : String = "This semester is quite busy semester for me, so I'm worried if I can deal with all assignments well";
let funFact : String = "I like carving rubber stamps";
